#pragma checksum "C:\Users\HP\source\repos\CoreDemo\CoreDemo\Areas\Admin\Views\Writer\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6360e4fb04346b685e64d4468dd55d5cc94a9f1f"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6360e4fb04346b685e64d4468dd55d5cc94a9f1f", @"/Areas/Admin/Views/Writer/Index.cshtml")]
    ...
    public class Areas_Admin_Views_Writer_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 2 "C:\Users\HP\source\repos\CoreDemo\CoreDemo\Areas\Admin\Views\Writer\Index.cshtml"
...
<button type=""button"" id=""btndeletewwriter"" class=""btn btn-outline-danger"">Yazar Sil</button>
<button type=""button"" id=""btnupdatewwriter"" class=""btn btn-outline-warning"">Yazar Güncelle</button>
<br />
<br />
<div id=""writerlist"">
...
<div>
    <input type=""text"" class=");
            WriteLiteral(@"""form-control"" id=""txtdeleteid"" placeholder=""Silinecek Yazar ID"" />
</div>
<br />
    ...
    ");
        ...
        $(""#btnaddwriter"").click(function () {
            ...
            $.ajax({
                ...
                data: writer,
                success: function (func) {
                    alert(""Yazar Ekleme İşlemi Başarılı Bir Şekilde Gerçekleştirildi."");
                }
            });
");
                WriteLiteral(@"        });

        $(""#btndeletewwriter"").click(x => {
            ...
            $.ajax({
                ...
                dataType: ""json"",
                success: function (func) {
                    alert(""Yazar Silme İşlemi Başarılı Bir Şekilde Gerçekleştirildi."");
                }
            });
        });

        $(""#btnupdatewwriter"").click(function () {
            let writer = {
                Id: $(""#txtid1"").val(),
            ...
            $.ajax({
                ...
                data: writer,
                success: function (func) {
                    alert(""Yazar Güncelleme İşlemi Başarılı Bir Şekilde Gerçekleştirildi."");
                }
            });
        });
    </script>
